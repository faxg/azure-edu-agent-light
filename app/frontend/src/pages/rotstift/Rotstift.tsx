...
import { Pen48Filled } from "@fluentui/react-icons";
import readNDJSONStream from "ndjson-readablestream";

import styles from "./Rotstift.module.css";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <Pen48Filled fontSize={"120px"} primaryFill={"rgba(115, 118, 225, 1)"} aria-hidden="true" aria-label="Rotstift logo" />
                            <h1 className={styles.chatEmptyStateTitle}>{"Rotstift"}</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>{"Provide better feedback on your students essays"}</h2>
                            {showLanguagePicker && <LanguagePicker onLanguageChange={newLang => i18n.changeLanguage(newLang)} />}

                            <div className={styles.chatEmptyStateExamples}>
                                <h3> Upload a student essay here, then click analyze. AI agents will collaborate to help you with your feedback.</h3>
                            </div>
                        </div>
                    ) : (
...
Component.displayName = "Rotstift";
