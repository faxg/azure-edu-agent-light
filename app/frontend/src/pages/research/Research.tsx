...
import { HatGraduation48Filled } from "@fluentui/react-icons";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <HatGraduation48Filled fontSize={"120px"} primaryFill={"rgba(115, 118, 225, 1)"} aria-hidden="true" aria-label="Research logo" />
                            <h1 className={styles.chatEmptyStateTitle}>{"Research Assistant"}</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>{"Effective guidance through litarature research"}</h2>
...
Component.displayName = "Research";
