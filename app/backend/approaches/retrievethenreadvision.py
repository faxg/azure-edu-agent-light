...
class RetrieveThenReadVisionApproach(Approach):
    ...
    system_chat_template_gpt4v = (
        "You are an intelligent assistant helping learners, teachers and faculity members to answer education related questions, the documents contain text, graphs, tables and images. "
